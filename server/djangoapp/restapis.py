...
def get_dealer_reviews_from_cf(url, **kwargs):
        ...
        if json_result:
            ...
            for dealer_review in reviews:
                ...
                sentiment=None,  # Initialize to None, will be updated later
...
def analyze_review_sentiments(text):
    url = "https://api.us-south.natural-language-understanding.watson.cloud.ibm.com/instances/6b47c87c-8374-46ca-b962-530557289ecf"
    api_key = "ahNJjBRAx-dZlrCOSwHPaQDc18c8itE7THEPQQ3rByIw"
